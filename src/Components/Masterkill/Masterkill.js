...
// var data = { line1: 12, line2: 13 };

// const masterkill = props =>
class Masterkill extends React.Component {
  constructor(props) {
    super(props);
    ...
    // console.log(this.state.isTimerPaused)
  }
  // var styleTable = { textAlign: "center" };
  ...
  handleVoterList(voterList) {
    ...
    this.setState({ votersList: voteListSort.sort((a,b)=>{
      return voterList.indexOf(b)-voterList.indexOf(a);
    })
    });
  }
  ...
  render() {
    ...
    const listVoters = this.state.votersList.sort((a,b)=>{
      return this.state.votersList.indexOf(b)-this.state.votersList.indexOf(a);
    })
    .map((voter, index) => (
      <tr key={index}>
            ...
            <Tabs className="z-depth-1">
              ...
              <Tab title="Rules" active>
                <ol>
                  ...
                  <li>2 teams of 2</li>
                  <li>Viewers vote for the worst killer before beginning of the game</li>
                  <li>No player pay with top#1 if not:</li>
                  <li>Viewer with correct vote is selected randomly after the game</li>
                  <li>
                    Worst player with less kills pay to the viewer amount equal
                    to sum of his section's kills or streamer pay sub for no sub viewer
                  </li>
                  <li>Payment only for 5 kills accrued by the team's kill</li>
                </ol>
              </Tab>
              <Tab title="Règles">
                <ol>
